...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_TYPE_OF_CANCER = "cancer_type";
    private static final String COLUMN_DATA_DISPLAY = "data_display";
    ...
    private String CREATE_USER_TABLE = "CREATE TABLE " + TABLE_USER + "("
            ...
            + COLUMN_USER_EMAIL + " TEXT," + COLUMN_USER_PASSWORD + " TEXT," +COLUMN_TYPE_OF_CANCER + " TEXT," +COLUMN_DATA_DISPLAY + " TEXT,"+COLUMN_SCORE+ " TEXT" + ")";
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_DATA_DISPLAY, user.getDataDisplay());
